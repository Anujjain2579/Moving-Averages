...
def main():
    ...
    if selection_option == "Upload CSV / Manual Entry":
        ...
        if uploaded_file is not None:
            ...
            symbols_input = st.sidebar.text_input("Enter stock symbols (comma-separated)", value="AJOONI,AKUMS,APOLLO,ARE&M,AVANTEL,COCHINSHIP,CYBERTECH,DAVANGERE,DCXINDIA,DELTACORP,DHANI,DISHTV,DOLATALGO,DUCON,EASEMYTRIP,EIHOTEL,FCSSOFT,FOSECOIND,HAL,HEMIPROP,HINDCOPPER,IDEA,IMAGICAA,INDOFARM,INDTERRAIN,INFIBEAM,INOXWIND,IRB,IRFC,JIOFIN,KIMS,LLOYDSENGG,MANAKCOAT,MANALIPETC,MOL,MOREPENLAB,NAM-INDIA,NAVKARCORP,NBCC,ODIGMA,ONEPOINT,ONMOBILE,PAISALO,PARACABLES,PARAGMILK,PFC,PIONEEREMB,PNGJL,PYRAMID,RADIANTCMS,RELINFRA,RENUKA,RIIL,RPOWER,SAIL,SALASAR,SARLAPOLY,SCILAL,SJVN,SOUTHWEST,SRF,SUBEXLTD,SUNDARAM,SUNFLAG,SUVIDHAA,SUZLON,SWANENERGY,SWSOLAR,TATAINVEST,TATASTEEL,VHL,WSTCSTPAPR,XTGLOBAL,ZEEL,ZEELEARN")
